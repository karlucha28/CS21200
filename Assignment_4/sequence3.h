// PROVIDED BY: ________Karl Savinskiy ID: 6575________ 
...
#include "./node/node1.h"   // Provides linked list toolkit
...
namespace main_savitch_5
{
    ...
    private:
        ...
        node* head_ptr;
        node* tail_ptr;
        node* cursor; // pointer to the cur item
        node* precursor; // pointer to the item before the current item
        size_type num_items; // number of items in the seq
    };
}
